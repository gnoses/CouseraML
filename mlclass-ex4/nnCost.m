...
% forward propagation
a2 = sigmoid(bsxfun(@plus,data * W1', (b1)));
a3 = sigmoid(bsxfun(@plus, a2* W2', (b2)));

% back propagation
d3 = -(a3 - groundTruth).*(a3 - groundTruth) .* a3 .* (1-a3);
d2 = (W2' * d3) .* a2 .* (1-a2);
